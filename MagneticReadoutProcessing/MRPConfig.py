...
class MRPConfig():
    ...
    # [MEASUREMENT]
    MEASUREMENT_HORIZONTAL_RESOLUTION = int()
    MEASUREMENT_VERTICAL_RESOLUTION = int()
    MEASUREMENT_READOUT_AVERAGING_POINT = bool()
    MEASUREMENT_SENSOR_MAGNET_DISTANCE = int()
    MEASUREMENT_SENSOR_Z_AXIS_INVERTED = bool()
    MEASUREMENT_HORIZONTAL_AXIS_DEGREE = int()
    MEASUREMENT_VERTICAL_AXIS_DEGREE = int()
    ...
    def __init__(self, _config: configparser):
        ...
        if _config is not None:
            # [HARDWARE]
            self.HARDWARE_GCODE_SERIAL_INTERFACE = _config['HARDWARE'].get('GCODE_SERIAL_INTERFACE')
            self.HARDWARE_READOUTUNIT_SERIAL_INTERFACE = _config['HARDWARE'].get('READOUTUNIT_SERIAL_INTERFACE')
            self.HARDWARE_AXIS_LIMIT_HORIZONTAL_MIN = _config['HARDWARE'].getint('AXIS_LIMIT_HORIZONTAL_MIN')
            self.HARDWARE_AXIS_LIMIT_HORIZONTAL_MAX = _config['HARDWARE'].getint('AXIS_LIMIT_HORIZONTAL_MAX')
            self.HARDWARE_AXIS_LIMIT_VERTICAL_MIN = _config['HARDWARE'].getint('AXIS_LIMIT_VERTICAL_MIN')
            self.HARDWARE_AXIS_LIMIT_VERTICAL_MAX = _config['HARDWARE'].getint('AXIS_LIMIT_VERTICAL_MAX')
            self.HARDWARE_READOUTUNIT_USER_ALTERNATIVE_UART_PROTOCOL = _config['HARDWARE'].getboolean('READOUTUNIT_USER_ALTERNATIVE_UART_PROTOCOL')
            # [MEASUREMENT]
            self.MEASUREMENT_HORIZONTAL_RESOLUTION = _config['MEASUREMENT'].getint('HORIZONTAL_RESOLUTION')
            self.MEASUREMENT_VERTICAL_RESOLUTION = _config['MEASUREMENT'].getint('VERTICAL_RESOLUTION')
            self.MEASUREMENT_READOUT_AVERAGING_POINT = _config['MEASUREMENT'].getint('READOUT_AVERAGING_POINT')
            self.MEASUREMENT_SENSOR_MAGNET_DISTANCE = _config['MEASUREMENT'].getint('SENSOR_MAGNET_DISTANCE')
            self.MEASUREMENT_SENSOR_Z_AXIS_INVERTED = _config['MEASUREMENT'].getboolean('SENSOR_Z_AXIS_INVERTED')
            self.MEASUREMENT_HORIZONTAL_AXIS_DEGREE = _config['MEASUREMENT'].getint('HORIZONTAL_AXIS_DEGREE')
            self.MEASUREMENT_VERTICAL_AXIS_DEGREE = _config['MEASUREMENT'].getint('VERTICAL_AXIS_DEGREE')
            self.MEASUREMENT_SENSOR_USE_Z_VALUE_AS_B = _config['MEASUREMENT'].getboolean('SENSOR_USE_Z_VALUE_AS_B')


            # [DEBUG]
            self.DEBUG_USE_SIMULATED_HARDWARE = _config['DEBUG'].getboolean('USE_SIMULATED_HARDWARE')
            self.DEBUG_MOVE_TO_AXIS_LIMITS = _config['DEBUG'].getboolean('MOVE_TO_AXIS_LIMITS')
            self.DEBUG_PERFORM_READ_SENSOR_TEST = _config['DEBUG'].getboolean('PERFORM_READ_SENSOR_TEST')
            self.DEBUG_DISABLE_MOTOR_MOVEMENTS = _config['DEBUG'].getboolean('DISABLE_MOTOR_MOVEMENTS')
        else:
            self.load_defaults()
