...
def main():
    ...
    magnet_readings: [MRPReading.MRPReading] = mrphelper.import_readings(READINGS_STORAGE_FOLDER, "fullsphere_magnet_(.)*.mag.json")
    ...
    if '360' in magnet_readings[0].get_name() or 'fullsphere' in magnet_readings[0].get_name():
