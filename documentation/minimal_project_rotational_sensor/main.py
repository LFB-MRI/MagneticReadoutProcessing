...
def main():
    ...
    # Please see MRP.MRPPolarVisualization file for further examples for plotting full sphere plots
    mrphelper.plot_fullsphere(magnet_readings, "example plot", RESULT_STORAGE_FOLDER)
