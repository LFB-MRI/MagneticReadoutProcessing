...
ten individual measured values. Here it can be seen that there are
...
that these are closest to the global mean value 208.8uT. The filter
algorithm implemented by the user was thus successfully executed using
the user-programmable pipeline. The calculation result was successfully
verified using raw measurement data and the final result of the
algorithm.
