...
B0 field strength of 50.4 mT, and an impressive homogeneity of 2400
\gls{ppm} over a 20cm diameter using smaller magnets
...
to achieve heightened accuracy, striving for precision levels below 1000
\gls{ppm}. While O'Reilly, Teeuwisse, and Webb were able to modify the
...
with the stringent criteria of achieving an accuracy level of 1000
...
\item
  ...
  stringent limit of less than 1,000 \gls{ppm}? The desired outcome is a
  measurement of less than 50 \(\mu\)T at 1000 \gls{ppm}, with a
  specific focus on determining the sensors' viability for noise
  measurements.
\end{itemize}
