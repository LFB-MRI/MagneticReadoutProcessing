...
<p class="fragment">&#x2022; Permanent magnets differ in their field strength due to their manufacture process and environmental changes</p>
...
<p class="fragment"> Buld an optimized magnet</p>

<hr>

::: {.container}
:::: {.col}
<h4 style="text-align: center;">BUT</h4>
::::
:::

<hr>

<p class="fragment">Projects exists that follow this approach but only implement individual parts</p>
<p class="fragment">Incompatible dataformats</p>
<p class="fragment">Complex magnetic field sensor integrations</p>
<p class="fragment">Usage of non opensource software</p>
<aside class="notes">
...
Allows rapid development of software analysation functions, without implementation of typical data processing pipelines providing:
